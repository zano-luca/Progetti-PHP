...
<head>
    ...
    <style>
        ...
        input{
            width: 30%;
            padding: 10px;
            margin-bottom: 15px; /* Margine inferiore di 15 pixel per separare dai successivi elementi */
            box-sizing: border-box; /* Il padding e il bordo sono inclusi nella larghezza totale */
            border: 1px solid #ccc; /* Bordo di 1 pixel con colore grigio chiaro */
...
<h1>Esegui un'operazione:</h1>

<form action="" method="post">
    <input type="text" name="a" placeholder="Primo termine:" value=<?=$a?> >
    <br>

    <input type="text" placeholder="Secondo termine:" name="b" value=<?=$b?>>
    <br>
    <br>
    <button type="submit" class="button button1" name="divisione">Divisione</button>
    <br>

    <button type="submit" class="button button2" name="moltiplicazione" >Moltiplicazione</button>
    <br>

    <button type="submit" class="button button3" name="addizione">Addizione</button>
    <br>

    <button type="submit" class="button button4" name="sottrazione">Sottrazione</button>
    <br>
    <br><br>

</form>

<h1 style="font-size: 30px">Il risultato è <?=$risultato?> </h1>
<br><br>
</body>
</html>